...
public abstract class FrameRecord implements Comparable<FrameRecord> {
    
    public final int frameIndex;
    public final int[] basicPots;
    public final String winnerName;
    
    FrameRecord(int frameIndex, int[] basicPots, String winnerName) {
    ...
    @Override
    public int compareTo(@NotNull FrameRecord o) {
        return Integer.compare(frameIndex, o.frameIndex);
    }
    
    public static class Snooker extends FrameRecord {
