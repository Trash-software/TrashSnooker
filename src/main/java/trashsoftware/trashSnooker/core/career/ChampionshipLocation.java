...
public class ChampionshipLocation {
    
    public final City city;
    public final TaxCountry taxCountry;
    
    public ChampionshipLocation(City city, TaxCountry taxCountry) {
        this.city = city;
        this.taxCountry = taxCountry;
    }
    
    public static ChampionshipLocation getDefaultSpawn() {
        return new ChampionshipLocation(TransportationManager.getInstance().getCityById("Chongqing"), TaxCountry.CHN);
    }
