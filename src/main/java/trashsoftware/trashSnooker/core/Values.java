...
//    public static final double[] NORMAL_315 = {1, -1};  // 左上至右下
    ...
    // 打中杆和打极限杆法球速的比例
    public static final double CUE_POINT_MULTIPLIER = 0.64;
    // 中杆击球最大速度，mm/s
    public static final double MAX_POWER_SPEED = 6400.0 / CUE_POINT_MULTIPLIER;
    // 由旋转产生的理论最大瞬时速度（该速度不可能达到），mm/s
    public static final double MAX_SPIN_SPEED = 5000.0 / CUE_POINT_MULTIPLIER;
    // 因为ball的spin值是球想要达到的速度，范围
    public static final double FRONT_SPIN_FACTOR = 1.45;
    // 由侧旋产生的最大瞬时速度，mm/s
    public static final double MAX_SIDE_SPIN_SPEED = 4400.0;
