...
public class FrameInfoRec {
    ...
    protected int winner;  // player 1 or 2
    protected FrameAnalyze<?> frameAnalyze;
    
    FrameInfoRec(MatchInfoRec parent) {
        this.parent = parent;
    }
    
    public static FrameInfoRec fromJson(MatchInfoRec parent, JSONObject json) {
        FrameInfoRec fir = new FrameInfoRec(parent);
